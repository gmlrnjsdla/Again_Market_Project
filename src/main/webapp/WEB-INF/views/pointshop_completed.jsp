...
<br><br><br><br>
<h3> ${nick } 님의 포인트상품 구매가 <br><br>정상적으로 완료되었습니다.</h3>
<br><br>
<h4>배송주소 : ${date }</h4>
<br><br><br><br><br><br>
...
<br><br>
<button type="button" class="btn btn-outline-secondary" style=" width: 310px;" onclick="script:window.location='pointshop'">다른 포인트상품 보러가기</button>
