...
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/shop_write/shop_write.js"></script>

<title>#### 포인트상품 등록 ####</title>
</head>
<body>
<%@ include file="include/leftBar.jsp" %>

<form action="pointshop_writeOk" method="post" enctype="multipart/form-data" name="shopwrite_frm">
...
<div class="card" style="width: 400px; height:750px; border:1px solid #dddddd; border-radius:5px; background-color:#FBFBFB ">
  ...
  <div id="image_preview">
    <input type="file" id="btnAtt"  name="files" accept=".gif, .jpg, .png"/>
    <div id="att_zone"
...
<div class="card" style="width: 350px; height:750px; border:1px solid #dddddd; border-radius:5px;">
  <div class="card-body"> 
		<div class="mb-3">
 		...
 		<div class="mb-3">
	      <input type="text" id="#" class="form-control" placeholder="point" name="spoint">
	    </div>
	    ...
	    <div class="mb-3">
	  	...
	  	<input class="btn btn-outline-secondary" type="button" value="입력" onclick="shopwriteCheck()" style="float:right; width: 310px; ">
